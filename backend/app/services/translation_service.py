...
- When the output language is Persian, use natural administrative meaning rather than a literal dictionary translation. For example, "fehlende Unterlagen" or "missing documents" means requested/incomplete documents (مدارک درخواستی or مدارک ناقص), not physically lost documents (مدارک مفقودشده), unless the source explicitly says they were lost.
